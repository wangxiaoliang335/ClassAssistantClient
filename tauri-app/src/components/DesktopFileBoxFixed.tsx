...
const DesktopFileBox = () => {
    ...
    return (
        <div
            className={`h-screen w-screen flex flex-col overflow-hidden select-none transition-all duration-300 ${isDragOver ? 'bg-blue-50 ring-4 ring-inset ring-blue-400' : 'bg-white'} shadow-[0_0_40px_rgba(0,0,0,0.1)] rounded-xl border border-gray-200 text-gray-800`}
        ...
        >
            {/* Header / Drag Region */}
            <div data-tauri-drag-region className="flex items-center justify-between px-4 py-3 bg-white border-b border-gray-200 cursor-move shrink-0">
            ...
            {contextMenu && (
                <div
                    className="fixed z-50 bg-white border border-gray-200 rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] py-1.5 min-w-[150px] animate-in fade-in zoom-in-95 duration-100 ring-1 ring-black/5"
